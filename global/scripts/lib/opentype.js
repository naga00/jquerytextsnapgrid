...
Font.prototype.forInitEachGlyph = function(text, x, y, fontSize, options, callback) {
    x = x !== undefined ? x : 0;
    y = y !== undefined ? y : 0;
    fontSize = fontSize !== undefined ? fontSize : 72;
    options = options || {};
...
var textWidth = 0;
Font.prototype.getTextWidth = function() {
  return textWidth;
};

Font.prototype.init = function(text, fontSize, options) {
    textWidth = 0;
    this.forInitEachGlyph(text, 0, 0, fontSize, options, function(glyph, gX, gY, gFontSize) {});  
};
